...
class BasePage():
    ...
    def find_element(self, how, what: str):
        """Returns the first element on the page

        Args:
            how (By): selenium.webdriver.common.by (By constant)
            what (str): selector/ID/CLASS...
        """
        return self.browser.find_element(how, what)

    def find_elements(self, how, what: str):
        """ Аналогично с find_element()
        """
